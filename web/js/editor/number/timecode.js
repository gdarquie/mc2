$('#editor_number_endTc').val(0);
$('#editor_number_endTc').prop('disabled', true);
$('#editor_number_beginTc').prop('disabled', true);
...
$('#tc_widget_beginTc input').change(function(){
    ...
    $('#editor_number_beginTc').val(tc_total);
});
...
$('#tc_widget_endTc input').change(function(){
    ...
    $('#editor_number_endTc').val(tc_total);
});
